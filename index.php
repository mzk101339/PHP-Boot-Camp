            ...
            <div class="card mt-4">
                <div class="card-title d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center p-2">
                        <img src="./img/profile.jpg" height="30" width="30" class="rounded-circle border">&nbsp;&nbsp;Guest
                    </div>
                    <div class="p-2">
                        <!-- 削除ボタン -->
                        <form method="post" action="delete.php">
                            <input type="hidden" name="post_id" value="<?php echo $post['id']; ?>">
                            <button type="submit" class="btn btn-link"><i class="bi bi-trash3" style="color: black; font-size: 20px;"></i></button>
                        </form>
                    </div>
                </div>
                <img src="data:image/jpeg;base64,<?= base64_encode($post['image']) ?>" style="width: 100%;" />
